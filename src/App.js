...
const App = () => {
  ...
  return (
    <GlobalContext.Provider value={{cotizacionDolar, cotizacionReal, ultimaActualizacion, setReloadingApp, usuA, setUsuA, idEtapa, setIdEtapa, idNeg, setIdNeg, idUser, setIdUser}}>
